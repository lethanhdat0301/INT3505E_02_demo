...
@books_bp.route('/api/v1/books/<int:id>', methods=['GET'])
@swag_from({
    'tags': ['Books'],
    'parameters': [
        {'name': 'id', 'in': 'path', 'type': 'integer', 'required': True, 'description': 'ID của sách'}
    ],
    'responses': {
        200: {
...
@books_bp.route('/api/v1/books/<int:id>', methods=['PUT'])
@swag_from({
    'tags': ['Books'],
    'parameters': [
        {'name': 'id', 'in': 'path', 'type': 'integer', 'required': True, 'description': 'ID của sách cần cập nhật'},
        {
            'name': 'book',
            'in': 'body',
            'required': True,
...
@books_bp.route('/api/v1/books/<int:id>', methods=['DELETE'])
@swag_from({
    'tags': ['Books'],
    'parameters': [
        {'name': 'id', 'in': 'path', 'type': 'integer', 'required': True, 'description': 'ID của sách cần xóa'}
    ],
    'responses': {
